...
module platformConnectivity 'br/public:avm/ptn/alz/empty:0.3.3' = {
  params: {
    ...
    waitForConsistencyCounterBeforeRoleAssignments: platformConnectivityConfig.?waitForConsistencyCounterBeforeRoleAssignment
